        ...
        if (null == jedisPool) {
            synchronized (Object.class) {
                if (null == jedisPool) {
                   ...
                   // JedisPool jedisPoolInstance = new JedisPool(config, "10.161.50.104", 9000);
                    JedisPool jedisPoolInstance = new JedisPool(config, "192.168.94.131", 6379);

                    jedisPool=jedisPoolInstance;
                    return jedisPool;
                }
            }
        }
